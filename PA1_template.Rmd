...
# Count the number of missing values, impute the missing values, create new data set with no missing data, and recalculate the histogram, mean, and median number of steps taken per day.
